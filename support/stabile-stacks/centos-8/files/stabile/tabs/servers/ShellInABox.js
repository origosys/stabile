...
linkifyURLs       = 1;
userCSSList       = [  ];
document.title = "Stabile Terminal";
...
var uuid = loc.substr(loc.indexOf("http://")+7,36);
fetch('/stabile/networks/' + uuid, opts).then(function (response) {
  return response.json();
}).then(function (body) {
  document.title = "Terminal: " + body.domainnames;
});
